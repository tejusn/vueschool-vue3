...
export default {
  ...
  computed: {
    thread () { // used in line 5 as thread.title and everywhere as thread
      return this.threads.find(thread => thread.id === this.id) // also available in this.$route.params.id
    },
    threadPosts () {
